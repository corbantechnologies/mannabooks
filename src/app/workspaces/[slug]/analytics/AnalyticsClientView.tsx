    ...
    <div className="space-y-10 font-mono text-xs selection:bg-black selection:text-white">
      ...
      <div className="card-modern p-6 bg-zinc-50/50 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-1">
          ...
          <div className="p-3 border border-zinc-200 bg-white space-y-1 rounded">
            <span className="text-[9px] text-zinc-400 uppercase block font-semibold">Taxable Sales Volume</span>
            <span className="text-base font-semibold text-black block">
          ...
          <div className="p-3 border border-zinc-200 bg-white space-y-1 rounded">
            <span className="text-[9px] text-zinc-400 uppercase block font-semibold">Zero-Rated Volume (0%)</span>
            <span className="text-base font-semibold text-black block">
          ...
          <div className="p-3 border border-zinc-200 bg-white space-y-1 rounded">
            <span className="text-[9px] text-zinc-400 uppercase block font-semibold">Exempt Sales Volume</span>
            <span className="text-base font-semibold text-black block">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 card-modern divide-y sm:divide-y-0 sm:divide-x divide-zinc-200/80 bg-white">
        <div className="p-6 space-y-1">
          <p className="text-[10px] text-zinc-400 uppercase font-semibold">Settled Operating Inflow</p>
        ...
        <div className="p-6 space-y-1">
          <p className="text-[10px] text-zinc-400 uppercase font-semibold">Settled Procurement Outflow</p>
          <p className="text-xl font-semibold tracking-tight text-black font-sans">
        ...
        <div className="p-6 space-y-1">
          <p className="text-[10px] text-zinc-400 uppercase font-semibold">Net Operating Cash Flow</p>
          <p className={`text-xl font-semibold tracking-tight font-sans ${data.netOperatingCashFlow >= 0 ? "text-emerald-700" : "text-rose-600"}`}>
        ...
        <div className="p-6 space-y-1">
          <p className="text-[10px] text-zinc-400 uppercase font-semibold">Accounts Receivable (A/R)</p>
          <p className="text-xl font-semibold tracking-tight text-black font-sans">
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          <h2 className="font-semibold uppercase text-sm tracking-wider text-black font-sans">&gt; Accounts Receivable (A/R) Aging Risk Matrix</h2>
          <span className="text-[10px] text-zinc-400 font-semibold uppercase font-mono">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 card-modern divide-y sm:divide-y-0 sm:divide-x divide-zinc-200/80 bg-white">
          <div className="p-4 space-y-1">
            <span className="text-[9px] text-zinc-400 uppercase block font-semibold">0 – 30 Days (Current)</span>
            <span className="text-lg font-semibold text-black block font-sans">
          ...
          <div className="p-4 space-y-1">
            <span className="text-[9px] text-zinc-400 uppercase block font-semibold">31 – 60 Days (Due Soon)</span>
            <span className="text-lg font-semibold text-black block font-sans">
          ...
          <div className="p-4 space-y-1">
            <span className="text-[9px] text-zinc-400 uppercase block font-semibold">61 – 90 Days (Late)</span>
            <span className="text-lg font-semibold text-black block font-sans">
          ...
          <div className="p-4 space-y-1">
            <span className="text-[9px] text-zinc-400 uppercase block font-semibold">90+ Days (Critically Overdue)</span>
            <span className="text-lg font-semibold text-rose-600 block font-sans">
              {formatCurrency(data.arAging.overdue90Plus, data.currency)}
            </span>
            <span className="text-[9px] text-rose-700 block font-semibold">High Risk Default Pool</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="card-modern p-6 space-y-4">
          <h2 className="font-semibold uppercase text-sm tracking-wider border-b border-zinc-200/80 pb-3 text-black font-sans">
          ...
          <div className="space-y-4">
            {data.topProducts.map((p, idx) => (
              <div key={p.id} className="space-y-1 font-mono text-xs">
                ...
                <div className="w-full h-2 bg-zinc-100 rounded-sm overflow-hidden">
                  <div
