    ...
    <div className="card-modern p-4 space-y-3 font-mono text-xs">
      <div className="flex justify-between items-center border-b border-zinc-100 pb-2">
        <div className="flex items-center gap-2">
          <span className="font-semibold uppercase tracking-tight text-xs text-black font-sans">Search Client Directory</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-end">
        ...
        <div className="sm:col-span-8 space-y-1">
          <label className="text-zinc-400 text-[10px] uppercase block font-semibold">Search Name / Email / Phone / Tax PIN</label>
          <input
            type="text"
            defaultValue={search}
