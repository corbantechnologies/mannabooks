  ...
  return (
    <div className="rounded-xl border border-gray-200 dark:border-white/8 bg-white dark:bg-white/3 p-5">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-sm font-semibold text-gray-800 dark:text-white">Hours Burn-Down — {monthName}</h3>
        {overrun > 0 && (
      ...
      <div className="grid grid-cols-3 gap-3 mb-4">
        <div className="text-center p-3 rounded-lg bg-gray-50 dark:bg-white/4">
          <p className="text-xl font-bold text-gray-900 dark:text-white">{allocated}h</p>
          <p className="text-[10px] text-gray-400 mt-0.5">Allocated</p>
        </div>
        <div className="text-center p-3 rounded-lg bg-gray-50 dark:bg-white/4">
        ...
        <div className="text-center p-3 rounded-lg bg-gray-50 dark:bg-white/4">
          {overrun > 0 ? (
            <>
              ...
              <p className="text-[10px] text-gray-400 mt-0.5">Overrun</p>
            </>
          ) : (
            <>
              <p className="text-xl font-bold text-emerald-500">{remaining.toFixed(1)}h</p>
      ...
      {overrun > 0 && hourlyRate > 0 && (
        <div className="mt-3 p-3 rounded-lg bg-red-50 dark:bg-red-500/8 flex items-center gap-2">
