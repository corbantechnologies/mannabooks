    ...
    <div className="card-modern p-4 space-y-4 font-mono text-xs">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3 items-end">
        ...
        <div className="lg:col-span-4 space-y-1">
          <label className="text-zinc-400 text-[10px] uppercase block font-semibold">Search Serial / Client / Item</label>
          <input
            type="text"
            defaultValue={search}
        ...
        {/* STATUS FILTER */}
        <div className="lg:col-span-2 space-y-1">
          <label className="text-zinc-400 text-[10px] uppercase block font-semibold">Status</label>
          <select
            value={status}
        ...
        {/* CLIENT FILTER */}
        <div className="lg:col-span-2 space-y-1">
          <label className="text-zinc-400 text-[10px] uppercase block font-semibold">Client Filter</label>
          <select
            value={clientId}
            onChange={(e) => handleFilterChange("clientId", e.target.value)}
            className="w-full px-2 py-1.5 border border-zinc-300 bg-white focus:outline-none focus:border-black rounded text-xs font-semibold uppercase"
          >
        ...
        {/* DATE RANGE FILTER */}
        <div className="lg:col-span-2 space-y-1">
          <label className="text-zinc-400 text-[10px] uppercase block font-semibold">From Date</label>
          <input
            type="date"
            value={fromDate}
