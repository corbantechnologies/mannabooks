// src/app/workspaces/[slug]/error.tsx
"use client";
...
export default function WorkspaceError({ error, reset }: WorkspaceErrorProps) {
  useEffect(() => {
    console.error("Workspace render error caught by boundary:", error);
  }, [error]);
      ...
      <div className="max-w-md w-full bg-white rounded-2xl border border-zinc-200/90 shadow-xl p-7 space-y-6">
        ...
        <div className="flex items-start gap-3.5">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500 mt-1">
              An unexpected issue occurred while rendering this workspace. If your session expired, clearing cookies will resolve it immediately.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-2.5 pt-2">
          ...
          >
            ...
            <span>Clear Cookies &amp; Sign In Again</span>
          </a>
          ...
          >
            ...
            <span>Return to Manna Books Home</span>
          </Link>
        </div>
