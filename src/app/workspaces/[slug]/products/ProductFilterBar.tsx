    ...
    <div className="border border-black bg-white p-4 space-y-3 font-mono text-xs">
      <div className="flex justify-between items-center border-b border-zinc-200 pb-2">
        <div className="flex items-center gap-2">
          <span className="font-bold uppercase tracking-tight text-xs">Search Product Catalog</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-end">
        ...
        <div className="sm:col-span-8 space-y-1">
          <label className="text-zinc-400 text-[10px] uppercase block">Search Item Name / SKU</label>
          <input
            type="text"
            defaultValue={search}
        ...
        <div className="sm:col-span-4 space-y-1">
          <label className="text-zinc-400 text-[10px] uppercase block">Statutory Tax Rule</label>
          <select
            value={taxType}
